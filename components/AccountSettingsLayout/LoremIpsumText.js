...
import {
  CasualTextMobile,
  SecondaryTextMobile,
  SubtitleHeaderMobile,
  SectionSubtitleMobile,
  StyledCardText,
} from "./AccountSettingsLayout.styled";

export const LoremIpsumText = ({subtitle}) => (
  <Card sx={{ paddingX: 2, paddingY: 2, backgroundColor: "#131B3F" }}>
      <SectionSubtitleMobile subtitle={subtitle} />
      <StyledCardText>
        <SecondaryTextMobile>
        ...
        <SubtitleHeaderMobile>Lorem ipsum</SubtitleHeaderMobile>
        <CasualTextMobile>
